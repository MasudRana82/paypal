...
<html>
    ...
    <body>
          {{-- Tutorial idea from : https://www.laravelia.com/post/laravel-10-paypal-payment-and-dive-into-details --}}
        ...
        @endif
                ...
                <a href="{{ route('make.payment') }}" class="btn btn-primary">Pay $100 from Paypal</a>
